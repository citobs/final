...
#     df_sum = pd.concat(map(pd.read_csv,[b1,b2,b3,b4,b5,b6,b7,b8,b9]))
#     df_sum.to_csv("g:/k/all.csv",encoding="utf-8-sig",index=None)

#사용예시
b = hp(url1,"p.menu_tit","g:/back1.csv")
c = df("g:/back1.csv", "back","g:/back4.csv")

b = hp(url2,"p.menu_tit","g:/back2.csv")
c = df("g:/back2.csv", "back","g:/back5.csv")
